...
class EmbeddingModel(Enum):
    ...
    TEXT_EMBEDDING_3_SMALL = ("text-embedding-3-small", 0.02/10**6, 1536)
    TEXT_EMBEDDING_3_LARGE = ("text-embedding-3-large", 0.13/10**6, 3072)
    TEXT_EMBEDDING_ADA_002 = ("text-embedding-ada-002", 0.01/10**6, 1536)
